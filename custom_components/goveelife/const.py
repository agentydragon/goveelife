...
# Temperature units - Govee API expects title case
GOVEE_TEMP_UNIT_CELSIUS: Final = "Celsius"
GOVEE_TEMP_UNIT_FAHRENHEIT: Final = "Fahrenheit"

# Common instance names
INSTANCE_POWER_SWITCH: Final = "powerSwitch"
